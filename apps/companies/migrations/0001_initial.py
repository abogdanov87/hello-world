# Generated by Django 2.2.6 on 2020-03-31 05:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('badge', models.CharField(blank=True, max_length=255, null=True, verbose_name='Логотип')),
                ('active', models.BooleanField(default=True, verbose_name='Статус активности')),
                ('user', models.ManyToManyField(related_name='user_companies', to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='companies.Company', verbose_name='Компания')),
                ('workplace', models.ManyToManyField(to='companies.Workplace', verbose_name='Рабочее место')),
            ],
            options={
                'db_table': 'employee',
            },
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='companies.DepartmentType', verbose_name='Тип подразделения'),
        ),
        migrations.AddField(
            model_name='department',
            name='parent',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='', max_length=2000, verbose_name='Наименование')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='companies.Employee', verbose_name='Сотрудник')),
                ('member_status', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='companies.MemberStatus', verbose_name='Статус участника')),
            ],
            options={
                'db_table': 'commission',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('education_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='companies.EducationType', verbose_name='Вид обучения')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='companies.Employee', verbose_name='Сотрудник')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active', models.BooleanField(default=True, verbose_name='Статус активности')),
                ('harmful_factor', models.ManyToManyField(to='companies.HarmfulFactor', verbose_name='Вредный фактор')),
                ('work_type', models.ManyToManyField(to='companies.WorkType', verbose_name='Вид работ')),
                ('working_condition_class', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='companies.WorkingConditionClass', verbose_name='Класс условий труда')),
                ('workplace', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='companies.Workplace', verbose_name='Рабочее место')),
            ],
            options={
